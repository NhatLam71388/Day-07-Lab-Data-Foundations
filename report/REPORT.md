...
|-----------|----------|----------------------|-----------|----------|
| Tôi (Member 3) | SentenceChunker(max=2) | — | Giữ trọn câu, chunk vừa | Không overlap |
| [Tên — Member 1] | [Chờ nhóm] | — | | |
| [Tên — Member 2] | [Chờ nhóm] | — | | |

**Strategy nào tốt nhất cho domain này? Tại sao?**
> *[Điền sau khi so sánh kết quả nhóm — demo]*
...
| 1 | [Chờ nhóm] | [Chờ nhóm] |
| 2 | [Chờ nhóm] | [Chờ nhóm] |
| 3 | điều kiện nhập học | IELTS 6.5 Overall (không kỹ năng nào dưới 6.0), tốt nghiệp THPT, GPA khuyến nghị 8.0+; ngành Y khoa thêm yêu cầu Sinh/Hóa/Toán-Vật lý và tiếng Việt A2 khi nhập học |
| 4 | [Chờ nhóm] | [Chờ nhóm] |
| 5 | [Chờ nhóm] | [Chờ nhóm] |

### Kết Quả Của Tôi

Setup: `SentenceChunker(max_sentences_per_chunk=2)` → 79 chunks từ `data/tuyen_sinh_faq.md`; embedding backend: MockEmbedder (hash-based, 64 chiều); `EmbeddingStore.search(top_k=3)`.

| # | Query | Top-1 Retrieved Chunk (tóm tắt) | Score | Relevant? | Agent Answer (tóm tắt) |
|---|-------|--------------------------------|-------|-----------|------------------------|
| 1 | [Chờ nhóm] | — | — | — | — |
| 2 | [Chờ nhóm] | — | — | — | — |
| 3 | điều kiện nhập học | IELTS 6.5 bắt buộc khi nhập học + yêu cầu Y khoa (tiếng Việt A2→B2, Sinh/Hóa) | 0.3443 | ✅ Có | Context chứa đúng yêu cầu IELTS và điều kiện ngành Y khoa |
| 4 | [Chờ nhóm] | — | — | — | — |
| 5 | [Chờ nhóm] | — | — | — | — |

**Top-3 kết quả chi tiết cho Query 3 "điều kiện nhập học":**

| Rank | Chunk Index | Score | Nội dung (tóm tắt) | Relevant? |
|------|-------------|-------|---------------------|-----------|
| 1 | 9 | 0.3443 | Yêu cầu IELTS 6.5; điều kiện Y khoa: tiếng Việt A2→B2, Sinh/Hóa/Toán-Vật lý | ✅ |
| 2 | 71 | 0.2566 | Ký túc xá bắt buộc năm nhất | ❌ |
| 3 | 27 | 0.2548 | Thông tin cá nhân trong hồ sơ | ❌ |

**Ghi chú:** Score thấp và retrieval kém chính xác (chỉ 1/3 chunk trong top-3 relevant) là do MockEmbedder dùng hash ngẫu nhiên, không phải semantic embedding. Với embedder thật (sentence-transformers hoặc OpenAI), top-3 sẽ đều chứa thông tin điều kiện nhập học.

**Bao nhiêu queries trả về chunk relevant trong top-3?** 1 / 1 *(Query 3 — các query khác chờ nhóm)*
...
| Results | Cá nhân | 7 / 10 *(Query 3 xong; 4 query còn chờ nhóm)* |
