...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Split on sentence boundaries using capturing parentheses to preserve delimiters
        parts = re.split(r'(\. |\! |\? |\.\n)', text)
        sentences = []
        ...
        # Filter out empty/only-whitespace sentences
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Merge processed_parts using sep
        chunks = []
        current_chunk = ""
        for part in processed_parts:
            ...
            if not current_chunk:
                ...
                extended = current_chunk + sep + part
                if len(extended) <= self.chunk_size:
                    current_chunk = extended
                else:
